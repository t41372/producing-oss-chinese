...
目前翻译工作已经完成，只是许多部分仍需要检查和润色。如果遇到任何问题或有任何建议，欢迎提交 issue。~~我会直接把你写的东西交给 AI~~。

这本书翻译时，我们 (我和 AI) 的假设是你至少看得懂一些英文，因此我们会保留人名和许多术语的英文原文，这对程序员来说可能比奇怪的翻译更熟悉。~~说是这么说，但 AI 具体翻译成什么样子谁知道呢ww~~
